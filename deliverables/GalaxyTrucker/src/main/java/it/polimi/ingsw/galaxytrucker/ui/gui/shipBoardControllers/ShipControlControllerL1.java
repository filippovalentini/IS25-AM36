...
/**
 * Controller for the ship control screen in Level 1 of the game.
 */
public class ShipControlControllerL1 extends ShipBoardGraphics implements ShipControlController {
    ...
    /**
     * Initializes the controller by loading the component images, setting up the game information,
     */
    @FXML
    ...
    /**
     * Sets the action buttons (destroy, crew, batteries) to be enabled or disabled.
     * @param disabled
     */
    ...
    /**
     * Initializes the assembled components on the ship board by retrieving them from the view and placing them on the grid.
     */
    ...
    /**
     * Sets up the crew button to allow the player to add crew members to their ship.
     */
    @FXML
    ...
    /**
     * Sets up the batteries button to allow the player to add batteries to their ship.
     */
    @FXML
    ...
    /**
     * Sets up the destroy button to allow the player to destroy a component on their ship.
     */
    @FXML
    ...
    /**
     * Updates the destroyed component on the ship board when a component is destroyed.
    ...
    /**
     * Updates the crew count on the ship board when a player adds or removes crew members.
    ...
    /**
     * Updates the battery count on the ship board when a player adds or removes batteries.
    ...
    /**
     * Updates the alien count on the ship board when a player adds or removes aliens from their cabin.
    ...
    /**
     * Updates the card picking phase by loading the flight phase screen for Level 1.
     * @throws Exception
     */
    @Override
    ...
    /**
     * Sets the player information including game ID, nickname, and color.
    ...
    /**
     * Updates the game phase displayed in the GUI.
