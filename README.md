...
## Executables
The jar exectuables are available at [jar artifacts](deliverables/GalaxyTrucker/out/artifacts).

## How to run Galaxy Trucker
### Server
1. Get the artifact from [server jar](deliverables/GalaxyTrucker/out/artifacts/ServerGalaxyTrucker)
...
### Client
#### Windows
1. Get the artifact from [client jar](deliverables/GalaxyTrucker/out/artifacts/ClientGalaxyTrucker)
