...
| Multiple games (FA) | ✅ |
| Persistence (FA) | :x: |
| Resilience to clients disconnections (FA) | :x: |
...
## Executables
The jar exectuables are available at [jar artifacts](deliverables/jars).

## How to run Galaxy Trucker
### Server
1. Get the artifact from [server jar](deliverables/jars/ServerGalaxyTrucker)
...
### Client
#### Windows
1. Get the artifact from [client jar](deliverables/jars/ClientGalaxyTrucker)
...
![impossibile to display deliverables/testCoverage/testCoverage.png](deliverables/testCoverage/testCoverage.png)
![impossible to display deliverables/testCoverage/testSuccess.png](deliverables/testCoverage/testSuccess.png)
